...
const LANGUAGES_BY_ABSTRACTION = [
  ...
  },
  {
    ...
    languages: [
      { name: "C++", desc: "Most widely used in robotics; high performance, object-oriented, used in ROS, drivers, and control loops." },
      ...
      <div className="space-y-3 border-b border-slate-100 dark:border-slate-800 pb-6">
        ...
        <div className="flex flex-wrap gap-2 pt-4">
          {[
            ...
            { id: "laws", label: "Laws & Ethics", icon: Scale, color: "emerald" },
            { id: "engineering", label: "Engineering & Languages", icon: Settings, color: "amber" }
          ].map((t) => {
            const Icon = t.icon;
          ...
          >
            ...
            <div className="rounded-2xl border border-slate-200/60 dark:border-slate-800/80 bg-white dark:bg-slate-900/40 p-5 shadow-sm space-y-3">
              ...
              <div className="flex items-center gap-2 text-xs text-slate-400">
                <span className="font-semibold text-slate-950 dark:text-white">Sense</span>
                <span>→</span>
                <span className="font-semibold text-slate-950 dark:text-white">Think</span>
                <span>→</span>
                <span className="font-semibold text-slate-950 dark:text-white">Act</span>
              </div>
            </div>
            ...
            <div className="rounded-2xl border border-slate-200/60 dark:border-slate-800/80 bg-white dark:bg-slate-900/40 p-5 shadow-sm space-y-3">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                {ROBOT_TYPES.map((r) => (
                  <div key={r.name} className="rounded-xl border border-slate-200/60 dark:border-slate-800/80 bg-white dark:bg-slate-900/40 p-4 space-y-1">
            ...
            <div className="rounded-2xl border border-slate-200/60 dark:border-slate-800/80 bg-white dark:bg-slate-900/40 p-5 shadow-sm space-y-3">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                {CORE_COMPONENTS.map((c) => (
                  <div key={c.title} className="rounded-xl border border-slate-200/60 dark:border-slate-800/80 bg-white dark:bg-slate-900/40 p-4 space-y-1">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              {ROBOTICS_LAWS.map((law) => {
                ...
                return (
                  <div
                    key={law.number}
                    className="rounded-2xl border border-slate-200/60 dark:border-slate-800/80 bg-white dark:bg-slate-900/40 p-5 shadow-sm space-y-2"
                  >
            ...
            <div className="rounded-2xl border border-slate-200/60 dark:border-slate-800/80 bg-white dark:bg-slate-900/40 p-5 shadow-sm space-y-3">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                {EMBEDDED_SYSTEMS.map((e) => (
                  <div key={e.title} className="rounded-xl border border-slate-200/60 dark:border-slate-800/80 bg-white dark:bg-slate-900/40 p-4 space-y-1">
                    ...
                    <div key={levelGroup.level} className="space-y-2">
                      ...
                      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-3">
                        {levelGroup.languages.map((lang) => (
                          <div key={lang.name} className="rounded-xl border border-slate-200/60 dark:border-slate-800/80 bg-white dark:bg-slate-900/40 p-3 space-y-1">
