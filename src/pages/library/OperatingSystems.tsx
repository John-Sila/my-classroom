...
export default function OperatingSystemsTopic() {
  const distros = [
    "Ubuntu", "Debian", "Fedora", "Red Hat Enterprise Linux", "CentOS",
    "Arch Linux", "Manjaro", "Linux Mint", "Kali Linux", "Pop!_OS",
    "openSUSE", "Alpine Linux", "Gentoo", "Zorin OS", "Elementary OS",
    "Raspberry Pi OS", "Oracle Linux", "Slackware", "MX Linux", "Parrot OS"
  ];
