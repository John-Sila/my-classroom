...
export default function OperatingSystemsTopic() {
  ...
  const distros = [
    ...
    {
      name: "Alpine Linux",
      family: "Ultra Lightweight",
      color: "from-blue-400/20 to-slate-400/10",
    ...
    {
      name: "MX Linux",
      family: "Midweight Debian",
      color: "from-neutral-600/20 to-slate-500/10",
      border: "border-neutral-600/20",
      glow: "group-hover:shadow-neutral-600/10",
    },
    {
      name: "Void Linux",
      family: "Independent Monolithic",
    ...
    {
      name: "Solus",
      family: "Independent Curated",
      color: "from-slate-400/20 to-blue-900/10",
      border: "border-slate-400/20",
      glow: "group-hover:shadow-slate-400/10",
    },
    {
      name: "Qubes OS",
      family: "Compartmental Security",
      color: "from-blue-700/20 to-indigo-900/10",
      border: "border-blue-700/20",
      glow: "group-hover:shadow-blue-700/10",
    },
    {
      name: "Tails",
      family: "Amnesic Incognito",
    ...
    },
    {
      name: "Parrot OS",
      family: "Security & Dev",
      color: "from-cyan-500/20 to-emerald-400/10",
      border: "border-cyan-500/20",
      glow: "group-hover:shadow-cyan-500/10",
    },
    {
      name: "Puppy Linux",
      family: "Ultra Portable Tiny",
      color: "from-yellow-600/20 to-amber-700/10",
      border: "border-yellow-600/20",
      glow: "group-hover:shadow-yellow-600/10",
    },
    {
      name: "OpenBSD",
      family: "Secure BSD Fork",
    ...
    {
      name: "DragonFly BSD",
      family: "Clustered BSD System",
      color: "from-red-600/20 to-amber-600/10",
      border: "border-red-600/20",
      glow: "group-hover:shadow-red-600/10",
    },
    {
      name: "Garuda Linux",
      family: "Performance Gaming",
      color: "from-fuchsia-600/20 to-violet-600/10",
      border: "border-fuchsia-600/20",
      glow: "group-hover:shadow-fuchsia-600/10",
    },
    {
      name: "Red Hat Enterprise",
      family: "Commercial Infrastructure",
      color: "from-red-700/20 to-neutral-900/20",
      border: "border-red-700/20",
      glow: "group-hover:shadow-red-700/10",
    },
    {
      name: "SUSE Linux Enterprise",
      family: "Global Business",
      color: "from-green-600/20 to-emerald-700/10",
      border: "border-green-600/20",
      glow: "group-hover:shadow-green-600/10",
    },
    {
      name: "Oracle Linux",
      family: "RHEL Enterprise Database",
    ...
    {
      name: "Clear Linux",
      family: "Intel Optimized Intel Architecture",
    ...
    {
      name: "Deepin",
      family: "Aesthetic Desktop Environment",
    ...
    {
      name: "Lite Linux",
      family: "Legacy Hardware Acceleration",
      color: "from-yellow-500/20 to-emerald-600/10",
      border: "border-yellow-500/20",
      glow: "group-hover:shadow-yellow-500/10",
    },
    {
      name: "Bodhi Linux",
      family: "Minimalist Enchantment Desktop",
      color: "from-lime-500/20 to-neutral-700/10",
      border: "border-lime-500/20",
      glow: "group-hover:shadow-lime-500/10",
    },
    {
      name: "Lubuntu",
      family: "Lightweight LXQt Ubuntu",
    ...
    {
      name: "Xubuntu",
      family: "Stable XFCE Ubuntu Layout",
      color: "from-blue-400/20 to-slate-400/10",
      border: "border-blue-400/20",
      glow: "group-hover:shadow-blue-400/10",
    },
    {
      name: "Kubuntu",
      family: "Powerful KDE Ubuntu Integration",
    ...
    {
      name: "CentOS Stream",
      family: "Upstream RHEL Sandbox",
      color: "from-purple-500/20 to-red-500/10",
      border: "border-purple-500/20",
      glow: "group-hover:shadow-purple-500/10",
    },
    {
      name: "Mageia",
      family: "Mandriva Community Successor",
      color: "from-cyan-400/20 to-blue-600/10",
      border: "border-cyan-400/20",
      glow: "group-hover:shadow-cyan-400/10",
    },
    {
      name: "ReactOS",
      family: "Open-Source Windows NT Engine",
      color: "from-slate-400/20 to-zinc-600/10",
      border: "border-slate-400/20",
      glow: "group-hover:shadow-slate-400/10",
    },
    {
      name: "Illumos",
      family: "OpenSolaris Fork Pipeline",
      color: "from-orange-600/20 to-amber-500/10",
      border: "border-orange-600/20",
      glow: "group-hover:shadow-orange-600/10",
    },
    {
      name: "SmartOS",
      family: "Hypervisor Specialized Engine",
      color: "from-purple-700/20 to-fuchsia-800/10",
      border: "border-purple-700/20",
      glow: "group-hover:shadow-purple-700/10",
    },
    {
      name: "Guix System",
      family: "GNU Purely Functional Config",
      color: "from-pink-600/20 to-yellow-600/10",
      border: "border-pink-600/20",
      glow: "group-hover:shadow-pink-600/10",
    },
    {
      name: "Devuan",
      family: "Systemd-Free Pure Debian",
      color: "from-purple-800/20 to-indigo-950/20",
      border: "border-purple-800/20",
      glow: "group-hover:shadow-purple-800/10",
    },
  ];
